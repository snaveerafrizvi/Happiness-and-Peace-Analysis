...
In this project, Python was used to analyze the general happiness level and peace values of countries around the world. We analyzed the time trends of the average values of these indices for both the top and worst-performing countries. A significant step in this project aims to see whether countries that have a female head of state/government fare better on these indices than male-led countries. 
...
* Data for Happiness Index: This is a Cantril ladder score, which is meant to represent happiness or subjective well-being. Respondents are asked to imagine a ladder with steps numbered from 0 to 10. They are then asked to rate their current lives based on where they consider themselves to stand on the ladder, with step 0 being the worst possible life and step 10 is the best one. We downloaded the data for the happiness index using an API request from the [World Happiness Report](https://www.worldhappiness.report/ed/2021/) published in the year 2021.
   * The World Happiness Report is a publication of the Sustainable Development Solutions Network, powered by data from the Gallup World Poll and Lloyd’s Register Foundation, which provided access to the World Risk Poll. The 2021 Report includes data from the ICL-YouGov Behaviour Tracker as part of the COVID Data Hub from the Institute of Global Health Innovation
